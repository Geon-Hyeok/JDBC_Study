...
public class StudentCUIApp {
	...
	public void addStudent() {
		...
		try {
			...
			String birthday; // 이름을 저장하기 위한 변수
			while (true) {
				...
				String birthdayReg = "(19||20)\\d{2}-(0[19]||1[0-2])-(0[1-9]||[12][0-9]||3[01])";
	...
	// => 키보드로 학번을 제외한 나머지 값을 입력받아 STUDENT 테이블에 저장된 학생정보를 변경하고
	// 처리결과를 출력하는 메소드
	...
	public void displayAllStudent() {
		...
		for (StudentDTO student : studentList) {
			// StudentDTO 클래스의 toString() 메소드 - StudentDTO 객체의 필드값을 반환
			System.out.println(student);
		}
		System.out.println("===================================");
	}
