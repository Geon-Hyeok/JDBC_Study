...
public class PreparedStatementApp {
	public static void main(String[] args) throws Exception {
		...
		String sql1 = "insert into student values(?, ?, ?, ?, ?)"; // 블완전한 SQL 명령
		...
		// PreparedStatement.executeUpdat() : PreparedStatement 객체에 저장된 DML 명령을
		...
		// 전달하여 실행하고 모든 검색행이 저장된 RsultSet 객체를 반환하는 메소드
		...
		*/
		...
		Connection con = ConnectionFactory.getConnection();
		String sql2 = "select * from student where name = ? order by no";
